...
def get_config():
    ...
    config.add_argument('--update_steps', type=int, default=4096)
    config.add_argument('--end', type=int, default=4000000)
    ...
    config.add_argument('--value_clip', type=float, default=1000)
